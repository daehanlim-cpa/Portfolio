                    ...
                    {visible.map((project, i) => (
                        ...
                        >
                            <Link
                                ...
                                className="group flex h-full flex-col rounded-xl bg-surface-muted p-7 transition-colors duration-300 hover:bg-surface-sunken sm:p-8"
                            >
                                <p className="text-caption font-medium text-ink-tertiary">{TYPE_LABEL[project.type]}</p>
                                <h2 className="mt-2 text-title-sm font-semibold tracking-[-0.02em] text-ink">{project.title}</h2>
                                <p className="mt-2 flex-1 text-caption leading-relaxed text-ink-tertiary">{project.shortDescription}.</p>
                                <div className="mt-8">
                                    <WorkVisual project={project} count={1} />
                                </div>
                            </Link>
                        </motion.li>
                    ))}
